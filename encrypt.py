...
pathToPDF = "" #Path to your PDF File
pdf_list = [pathToPDF]
...
userPass = input()
adminPass = input()
write_obj.encrypt(userPass, adminPass, True)

openMergedFilePDF = open("encrypt.pdf", "wb")   #writing the file in binary code as its not text document
